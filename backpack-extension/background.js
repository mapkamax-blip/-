...
function setupOpenBagMenu() {
  lib_default.contextMenu.create({
    ...
    icons: [
      {
        icon: "https://mapkamax-blip.github.io/-/backpack-extension/icons/backpack.svg?v=5",
        label: "\u0420\u044E\u043A\u0437\u0430\u043A",
        filter: {
          max: 1,
    ...
    embed: {
      url: "https://mapkamax-blip.github.io/-/backpack-extension/inventory.html?v=5",
      height: 420
    }
  });
}
function setupAddToBagMenu() {
  lib_default.contextMenu.create({
    ...
    icons: [
      {
        icon: "https://mapkamax-blip.github.io/-/backpack-extension/icons/add-item.svg?v=5",
