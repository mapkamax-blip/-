...
console.log("[\u0420\u044E\u043A\u0437\u0430\u043A] background.js \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043D, \u0436\u0434\u0451\u043C OBR.onReady...");
var ID = "rodeo.maxim.backpack";
var ITEMS_KEY = `${ID}/items`;
lib_default.onReady(() => {
  console.log("[\u0420\u044E\u043A\u0437\u0430\u043A] OBR \u0433\u043E\u0442\u043E\u0432, \u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u0443\u044E \u043F\u0443\u043D\u043A\u0442\u044B \u043C\u0435\u043D\u044E");
  setupOpenBagMenu();
  setupAddToBagMenu();
  console.log("[\u0420\u044E\u043A\u0437\u0430\u043A] \u043F\u0443\u043D\u043A\u0442\u044B \u043C\u0435\u043D\u044E \u0437\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u043D\u044B");
});
function setupOpenBagMenu() {
  lib_default.contextMenu.create({
    ...
    icons: [
      {
        icon: "https://mapkamax-blip.github.io/-/backpack-extension/icons/backpack.svg?v=7",
        label: "\u0420\u044E\u043A\u0437\u0430\u043A",
        filter: {
          max: 1,
    ...
    embed: {
      url: "https://mapkamax-blip.github.io/-/backpack-extension/inventory.html?v=7",
      height: 420
    }
  });
}
function setupAddToBagMenu() {
  lib_default.contextMenu.create({
    ...
    icons: [
      {
        icon: "https://mapkamax-blip.github.io/-/backpack-extension/icons/add-item.svg?v=7",
...
async function addSelectedItemToBag(items) {
  ...
  const entry = {
    ...
    text: itemToken.text,
    textItemType: itemToken.textItemType
  };
  await lib_default.scene.items.updateItems([character], (drafts) => {
    for (const draft of drafts) {
      const current2 = draft.metadata[ITEMS_KEY] || [];
      draft.metadata[ITEMS_KEY] = [...current2, entry];
    }
  });
  await lib_default.scene.items.deleteItems([itemToken.id]);
  lib_default.notification.show(`\xAB${entry.name}\xBB \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u0432 \u0440\u044E\u043A\u0437\u0430\u043A`, "SUCCESS");
}
export {
  ITEMS_KEY
};
