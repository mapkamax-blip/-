...
console.log("[\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430] background.js \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043D, \u0436\u0434\u0451\u043C OBR.onReady...");
var ID = "rodeo.maxim.charsheet";
var DATA_KEY = `${ID}/data`;
var CHANNEL = `${ID}/broadcast`;
var BASE = "https://mapkamax-blip.github.io/-/charsheet-extension";
lib_default.onReady(() => {
  setupShowMenu();
  setupHideMenu();
  setupEditMenu();
  listenForBroadcasts();
  console.log("[\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430] \u043F\u0443\u043D\u043A\u0442\u044B \u043C\u0435\u043D\u044E \u0437\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u043D\u044B");
});
function setupShowMenu() {
  lib_default.contextMenu.create({
    id: `${ID}/show-menu`,
    icons: [
      {
        icon: `${BASE}/icons/show.svg?v=1`,
    ...
    async onClick(context) {
      ...
      await lib_default.broadcast.sendMessage(
        CHANNEL,
        { action: "show", tokenId: token.id, card },
        { destination: "ALL" }
      );
    }
  });
...
function setupHideMenu() {
  lib_default.contextMenu.create({
    ...
    icons: [
      {
        icon: `${BASE}/icons/hide.svg?v=1`,
        label: "\u0421\u043A\u0440\u044B\u0442\u044C \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0443",
        filter: {
          max: 1,
          every: [{ key: "layer", value: "CHARACTER" }]
        }
...
function setupEditMenu() {
  lib_default.contextMenu.create({
    ...
    embed: {
      url: `${BASE}/edit.html?v=1`,
      height: 480
    }
  });
}
function listenForBroadcasts() {
  lib_default.broadcast.onMessage(CHANNEL, (event) => {
    const { action, tokenId, card } = event.data || {};
    if (!tokenId) return;
    const popoverId = `${ID}/popover-${tokenId}`;
    if (action === "show") {
      lib_default.popover.open({
        id: popoverId,
        url: `${BASE}/card-view.html?v=1&data=${encodeURIComponent(JSON.stringify(card))}`,
        width: 260,
        height: 420,
        anchorReference: "POSITION",
        anchorPosition: { left: 70, top: 90 },
        hidePaper: true
      });
    } else if (action === "hide") {
      lib_default.popover.close(popoverId);
    }
  });
}
